...
DROP TABLE IF EXISTS schools.system_variables;
DROP TABLE IF EXISTS schools.user_pin_history;
DROP TABLE IF EXISTS schools.role;
DROP TABLE IF EXISTS schools.timetable;
DROP TABLE IF EXISTS schools.period;
DROP TABLE IF EXISTS schools.test_result;
DROP TABLE IF EXISTS schools.test;
DROP TABLE IF EXISTS schools.relation_session_student;
DROP TABLE IF EXISTS schools.relation_parent_student;
DROP TABLE IF EXISTS schools.session;
DROP TABLE IF EXISTS schools.user;
DROP TABLE IF EXISTS schools.class;
DROP TABLE IF EXISTS schools.branch;
DROP TABLE IF EXISTS schools.address;
DROP TABLE IF EXISTS schools.institute;
DROP TABLE IF EXISTS schools.code;
DROP TABLE IF EXISTS schools.code_type;

CREATE TABLE IF NOT EXISTS `schools`.`CODE_TYPE` (
...
CREATE TABLE IF NOT EXISTS `schools`.`CODE` (
  ...
  CONSTRAINT `FK_CODE_1`
    ...
    REFERENCES `schools`.`CODE_TYPE` (`CODE_TYPE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `schools`.`ADDRESS` (
...
CREATE TABLE IF NOT EXISTS `schools`.`SYSTEM_VARIABLES` (
...
CREATE TABLE IF NOT EXISTS `schools`.`INSTITUTE` (
...
CREATE TABLE IF NOT EXISTS `schools`.`BRANCH` (
  ...
  CONSTRAINT `FK_BRANCH_1`
    ...
    REFERENCES `schools`.`INSTITUTE` (`INSTITUTE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_BRANCH_2`
    FOREIGN KEY (`BRANCH_ADDRESS_ID`)
    REFERENCES `schools`.`ADDRESS` (`ADDRESS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `schools`.`RELATION_PARENT_STUDENT` (
  ...
  CONSTRAINT `FK_RELATION_PARENT_STUDENT_1`
    ...
    REFERENCES `schools`.`USER` (`USER_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `FK_RELATION_PARENT_STUDENT_3`
    ...
    REFERENCES `schools`.`CODE` (`CODE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `schools`.`USER` (
  ...
  CONSTRAINT `FK_USER_5`
    ...
    REFERENCES `schools`.`BRANCH` (`BRANCH_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `schools`.`USER_PIN_HISTORY` (
...
CREATE TABLE IF NOT EXISTS `schools`.`CLASS` (
...
CREATE TABLE IF NOT EXISTS `schools`.`SESSION` (
  ...
  CONSTRAINT `FK_SESSION_1`
    ...
    REFERENCES `schools`.`CLASS` (`CLASS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `schools`.`RELATION_SESSION_STUDENT` (
  ...
  CONSTRAINT `FK_RELATION_SESSION_STUDENT_1`
    ...
    REFERENCES `schools`.`SESSION` (`SESSION_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `schools`.`TIMETABLE` (
  ...
  CONSTRAINT `FK_TIMETABLE_4`
    ...
    REFERENCES `schools`.`PERIOD` (`PERIOD_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `schools`.`PERIOD` (
...
CREATE TABLE IF NOT EXISTS `schools`.`TEST` (
...
CREATE TABLE IF NOT EXISTS `schools`.`TEST_RESULT` (
  ...
  CONSTRAINT `FK_TEST_RESULT_1`
    ...
    REFERENCES `schools`.`TEST` (`TEST_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `schools`.`ATTENDENCE` (
...
CREATE TABLE IF NOT EXISTS `schools`.`ROLE` (
